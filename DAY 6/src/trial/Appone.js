			...
			<main className="container mx-auto px-6 pt-16 flex-1 text-center">
				...
				<form 
					...
					<div className="opacity-75 italic">
						By subscribing, you agree with Revue's <a target="_blank" className="hover:opacity-80 duration-150"><Link to="/privacy">Terms of Service</Link></a> and <a target="_blank" className="hover:opacity-80 duration-150"><Link to="/privacy">Privacy Policy </Link></a>.
					</div>
